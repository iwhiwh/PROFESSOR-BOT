...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/10c4c1097b9d77cf92ff1.jpg')).split()
BOT_START_TIME = time()
...
BUTTON_LOCK_TEXT = environ.get("BUTTON_LOCK_TEXT", "ये आपके लिए नई है.....😒")
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', '👉 पहले हमारे चेनल को जॉइन करे....😒 \n👉 तभी मूवी मिलेगा....😏 
